  ...
  getMockQuestions: function() {
    return {
      0: { // 第1题：我在deadline前效率最高
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "你是懂科研的"
        }
      },
      3: { // 第4题：实验室的咖啡机是我最好的朋友
        triggerAnswers: [1, 2], // 中立和不认同
        mockTextByAnswer: {
          1: "该不会你们实验室连咖啡机都没有吧",
          2: "该不会你们实验室连咖啡机都没有吧"
        }
      ...
      14: { // 第15题：我觉得快速发表比深入研究更有价值
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "你是懂科研的"
        }
      },
      17: { // 第18题：我经常主动加班，让同门感到压力
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "家里进鬼了，你知道是谁吗"
        }
      },
      18: { // 第19题：我享受让同门感到追赶不上的感觉
        triggerAnswers: [0, 1], // 认同和中立
        mockTextByAnswer: {
          0: "下头",
          1: "下头"
        }
      },
      21: { // 第22题：我觉得读研后发量明显减少
        triggerAnswers: [2], // 只有不认同
        mockTextByAnswer: {
          2: "课题组氛围这么好吗？导师不压力吗？"
        }
      },
      23: { // 第24题：我掌握了'看起来在认真看文献'的技巧
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "教教我吧？求你了"
        }
      },
      25: { // 第26题：我能记住实验室所有人的生日和爱好
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "真好，这么细心，肯定有对象了！"
        }
      },
      32: { // 第33题：我经常给导师带小礼物或家乡特产
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "呦呦呦，这不特长哥/姐来了吗！"
        }
      },
      34: { // 第35题：我记住导师所有喜欢的茶叶口味
        triggerAnswers: [0], // 只有认同
        mockTextByAnswer: {
          0: "茶叶哥也来了"
        }
