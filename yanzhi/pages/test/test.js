...
Page({
  ...
  getMockQuestions: function() {
    return {
      ...
      45: { // 第46题：我觉得研究生的快乐很简单：数据好看、论文录用
        triggerAnswers: [0, 1, 2], // 所有答案都嘲笑
        mockTextByAnswer: {
          0: "该不会你就是这么容易满足吧",
          1: "该不会你偶尔也这么觉得吧",
